...
function nuisance_txt = fmriprep_cfd_nuisance_txt(func_dir, nuisance)
    ...
    if ~isfile(nuisance_txt)
        ...
        cfd_struct.rp24 = table(cfds_T.trans_x, cfds_T.trans_y, cfds_T.trans_z,...% translations
                                 ...
                                 fmriprep_cfd_replace_firstvol(cfds_T.trans_x_derivative1, 'mean'),...% derivatives
                                 fmriprep_cfd_replace_firstvol(cfds_T.trans_y_derivative1, 'mean'),...
                                 fmriprep_cfd_replace_firstvol(cfds_T.trans_z_derivative1, 'mean'),...
                                 fmriprep_cfd_replace_firstvol(cfds_T.trans_x_derivative1_power2, 'mean'),...% derivatives squared
                                 fmriprep_cfd_replace_firstvol(cfds_T.trans_y_derivative1_power2, 'mean'),...
                                 fmriprep_cfd_replace_firstvol(cfds_T.trans_z_derivative1_power2, 'mean'),...
                                 cfds_T.rot_x, cfds_T.rot_y, cfds_T.rot_z,...% rotations
                                 cfds_T.rot_x_power2, cfds_T.rot_y_power2, cfds_T.rot_z_power2,...% squared 
                                 fmriprep_cfd_replace_firstvol(cfds_T.rot_x_derivative1, 'mean'),...% derivatives
                                 fmriprep_cfd_replace_firstvol(cfds_T.rot_y_derivative1, 'mean'),...
                                 fmriprep_cfd_replace_firstvol(cfds_T.rot_z_derivative1, 'mean'),...
                                 fmriprep_cfd_replace_firstvol(cfds_T.rot_x_derivative1_power2, 'mean'),...% derivatives squared
                                 fmriprep_cfd_replace_firstvol(cfds_T.rot_y_derivative1_power2, 'mean'),...
                                 fmriprep_cfd_replace_firstvol(cfds_T.rot_z_derivative1_power2, 'mean')); 
